...
export default function Index({ allPosts, allWork }) {
  const shortAboutText = (
    <p className="mt-8 text-left">
      Hi, I'm Shrey. I build tools at{' '}
      {darkModeLinkStyleTag('Wayground', 'https://wayground.com/')} that stand
      between teachers and everything else that isn't teaching.
      <br />
      <br />
      In the past, I worked with{' '}
      {darkModeLinkStyleTag('Clari', 'https://www.clari.com/')} to surface
      conversational intelligence for sales teams and helped build context-rich
      SQL editor (and other odd jobs) at{' '}
      {darkModeLinkStyleTag('Atlan', 'https://atlan.com/')}.
      <br />
      <br />
      I've also built tools to study technology use in families. I have two
      cats, love talking about sustainable lifestyles, a huge fan of{' '}
